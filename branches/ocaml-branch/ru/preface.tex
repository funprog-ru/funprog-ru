...
Эта книга основана на конспектах лекций по курсу {\em Введение в
  функциональное программирование}, который я читал в университете
Кембриджа в 1996/7 учебном году.

Курс читался студентам последнего курса и аспирантам первого года
обучения.  К тому времени они уже свободно владели императивным
программированием на языке Modula-3, a параллельно с этим курсом им
читался курс по C.  Этот курс определённо является курсом по
функциональному программированию, а не курсом по программированию с
использованием функциональных языков.  Я попытался сделать упор на
...
звёздочкой размещён дополнительный материал, который не входит в
экзамены, и который можно пропустить без потери понимания курса.
Однако, я надеюсь, что некоторые заинтересуются более глубоким
изучением отдельных частей курса и эти люди убедятся, что разделы,
...
Большая часть глав включает примеры, либо созданные
