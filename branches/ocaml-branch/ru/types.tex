...
так и функциональные (ISWIM, SASL и~Erlang).% 
\footnote{В языках ISWIM и Erlang реализован динамический контроль типов
(Wikipedia).~--- {\sl Прим.\ перев.}} 
Другие, подобно~PL/I, имеют
