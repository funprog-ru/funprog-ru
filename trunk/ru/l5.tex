...
Просто уберите {\black \tt in} и завершите выражение:
...
ML печатает типовые переменные как {\black \tt 'a}, {\black \tt 'b}
и~т.д.  Предполагается, что они являются ASCII представлением для
{\black $\alpha$}, {\black $\beta$} и~т.д.  Теперь мы можем
