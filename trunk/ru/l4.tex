...
\frame{
  ...
  произведение типов \alert{$\alpha \times \beta$}, а также типовые {\em
    переменные}, участвующие в полиморфизме.  Обычно мы используем \alert{
    $\alpha$} и \alert{$\beta$} для типовых переменных.
