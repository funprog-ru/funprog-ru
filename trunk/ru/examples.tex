...
\noindent Аккумулятор переменных {\tt insts} должен пополнятся с некоторой 
...
языков. Другие символьные операции имеют ???определённые ограничения~-- 
...
Первое определение <<вычислимого вещественного числа>> в нашем смысле 
первоначально было дано в \citeN{turing}. Его подход основывался на
десятичных расширениях, но позже потребовались изменения~--\cite{turing2},
по причинам, рассматриваемым нами далее в упражнениях. Подход к 
вещественной арифметике, осуществлённый нами, основывается на работе 
\citeN{boehm-cartwright}. Недавняя более эффективная реализация в CAML Light
...
\item Попробуйте запрограммировать простую процедуру интегрирования.
В общем, она не 
