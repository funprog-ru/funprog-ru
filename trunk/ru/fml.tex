...
должен соответствовать disjoint???? объединению двух существующих
типов.
% BUG# disjoint union ? наверное, несвязное объединение - \sqcup, когда попарно не пересекаются объединяемые множества -- dimiii 
