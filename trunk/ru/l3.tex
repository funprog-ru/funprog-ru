...
то мы обнаружим, что {\red $\mbox{fact}$} есть неподвижная точка функции
...
хотим задать выражение рекурсивно, то добавляем слово {\red
  $\mbox{rec}$}.  Например:
...
{\red \tt let} конструкции; таким образом, программа преобретает
