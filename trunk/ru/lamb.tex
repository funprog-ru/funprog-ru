...
Similarly, in $\lambda$- notation, $\lamb{x} E[x]$ and $\lamb{y} E[y]$ are equivalent;
this is called {\em alpha}-equivalence and the process of transforming between such pairs
is called alpha-conversion. We should add the proviso that $y$ is not a free variable in
$E[x]$, or the meaning clearly may change, just as
