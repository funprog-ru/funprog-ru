...
и что мы можем двукратно примененить правило типизации комбинации термов
...
\footnote{Приведённая нами формулировка теоремы была опубликована в работе
...
полиномами либо кусочными функциями на их основе.
...
\item 
Докажите формально теорему~\ref{TPT} о type preservation для $\alpha$
