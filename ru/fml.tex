...
вычислимыми, есть смысл ограничиться только ними. С таким ограничением возможно
...
см.\ работу~\cite{avl} либо другие книги по алгоритмам.}
...
<<гомоморфизме Карри-Говарда>>~--- подробнее см.~\cite{girard-prat}.} 
