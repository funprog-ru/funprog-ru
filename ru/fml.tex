...
Не сложно задать рекурсивную фунцию, принимающую в качестве аргументов целочисленное
$n$ и функцию  $f$, а возвращающую $f^n$, т.е. $f \circ \cdots \circ f$ ($n$~раз):
...
арифметических операций. ML не имеет функции для возведения в степень, но её легко 
задать по рекурсии:
...
Это решение выполняет $n$ произвелений для вычисления $x^n$. Более эффективный
...
наибольшего  общего делителя (НОД) при помощи алгоритма Евклида:
