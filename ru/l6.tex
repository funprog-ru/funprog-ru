...
положительное число {\red $n$} и функцию {\red $f$}, а возвращает {\red
...
Теперь мы можем задать функции используя сопоставление с образцом.  Например,
мы можем задать функции взятия головы и хвоста списка:
