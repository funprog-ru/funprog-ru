...
т.~е.\ между существующими требованиями к программе и её существующей реализацией.
...
постараться сохранять их несущественными, используя прагматичную модель системы
и высокуровневую достаточно читабельную математическую спецификацию.
...
mathematics (??).
% COMMENT#  может тупо 'функциональных пространств в ML с математическими
% функциональными пространствами' ? --lg
...
неопределёнными. Анализ всюду определённых функций менее трудоёмок, но
иногда требуется отдельное доказательство завершимости вычислений.
...
является то, что при~$y \not= 0$ найдётся такое~$q$ что~$x = q y + r$
...
В работе~\citeN{neumann-risks} приведён обзор рисков, связанных как с 
