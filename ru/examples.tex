...
вывода, обсуждаются в работе~\citeN{oppen-pretty}. Мы не будем рассматривать их 
...
систему наподобие описанной в работе~\citeN{stickel-pttp}. Далее мы покажем, как в сущности на тех же 
...
предметом интенсивных исследований, и работа~\citeN{davenport-ca} 
содержит обзор возможностей систем компьютерной алгебры и их устройства.
В работе~\citeN{paulson-rewriting} обсуждается в более общем виде стратегия 
...
одной из первых работ по данной теме считается~\citeN{burge-recursive}. Наши примеры 
основаны на \citeN{paulson-ml} и \citeN{reade-efp}.
...
Первое определение <<вычислимого вещественного числа>> было дано Тьюрингом~\citeN{turing}. 
...
Наш подход к вещественной арифметике основан на работе~\citeN{boehm-cartwright}. 
Недавняя, более эффективная, реализация на CAML Light
была описана в \citeN{menisse-thesis}. Эта диссертация (на французском)
...
данной задачи в терминах <<дробно-линейных преобразований>>~\citeN{potts-thesis}.
...
Пролога приводятся, например, в~\citeN{boizumault-prolog}, а с подробностями
практического применения этого языка стоит ознакомиться по~\citeN{clocksin-mellish}.
Детальное обсуждение продолжений во многих их проявлениях даётся 
в \citeN{reynolds-continuations}. Алгоритм унификации, рассмотренный в 
курсе, прост и достаточно функционален, но не блещет эффективностью.
Информация о более быстрых императивных алгоритмах содержится в работе~\citeN{martelli-montanari}.
...
(не содержащее $\sin$, $\ln$ и пр.) --- подробности см.\ в работе~\citeN{davenport-integration}.}
...
основе работы~\citeN{martelli-montanari}.
