...
Аналогичная ситуация возникает в большинстве языков программирования, по крайней мере, среди
...
Между прочим, заметим, что {\em область видимости} переменной не следует отождествлять с её
...
Одной из привлекательных черт $\lambda$-нотации является то, что все операции
связывания переменных, такие как суммирование, дифференцирование и интегрирование, могут
рассматриваться как функции, применяемые к $\lambda$-выражениям.  Обобщение всех операций
связывания переменных с помощью $\lambda$-абстракции, позволяет нам сконцентрироваться на
...
записи логики высшего порядка в $\lambda$-нотации, использованной Чёрчем, а также, как мы
увидим в следующей главе, Лэндин указывал на то, как много конструкций в языках
...
как и переменные, отличая их друг от друга по контексту.
...
основанное на нём.\ Konstant, в честь его немецкого происхождения (автор 
