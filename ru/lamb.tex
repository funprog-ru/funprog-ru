...
разработанную Чёрчем~\citeN{church-book}:
...
математика-логика Карри~\citeN{curry-comb}. (В действительности, такой приём уже использовался и
Фреге~\citeN{frege-arith}, и Шейнфинкелем~\citeN{schonfinkel}, но легко понять, почему соответствующие
...
Для того, чтобы избежать таких парадоксов, \citeN{church-types} развивает идею Рассела
путём добавления в $\lambda$-нотацию понятия {\em типа}, которое будет подробно рассмотрено
...
в другую. Как писал Уайтхед в работе~\citeN{whitehead-intro}, формальная
...
часть~\citeN{gordon-plt} представляет собой упрощённое изложение предмета,
