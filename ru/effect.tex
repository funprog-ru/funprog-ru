...
и многими другими языками с динамическими переменными, таким как С. 
...
лямбда-абстракциями.  Некоторые интересные примеры мы рассмотрим
позже.  С другой стороны, может статься кому-то потребуется
принудительное вычисление выражений под лямбда-абстракциями.
Например:
...
поскольку до этого оно находится под лямбда-абстракцией. Более
...
комбинаторов, с не особо явными лямбда-абстракциями, больше
возможностей, во время декларации вычислить настолько большую часть
...
Решение Wright'a, с другой стороны, использует только основной синтаксис
