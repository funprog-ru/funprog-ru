...
% mapping of symbol sequences to latex char
\lstset{literate={->}{{$\to{}$}}1}
...
\noindent Оригинальный курс: 
\texttt{http://www.cl.cam.ac.uk/Teaching/Lectures/funprog-jrh-1996/}

\vspace{\baselineskip}

\noindent Сайт проекта перевода:
\texttt{http://code.google.com/p/funprog-ru/}
