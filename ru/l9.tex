...
\frame{
  ...
  \item {\em Синтаксический разборщик},  принимающий ввод в человеко - читаемой форме,
  ...
  Мы будем использовать синтаксический разбор как ещё один важный пример применения  
...
\frame{
  ...
  пользователем, будет печататься ею.
...
\frame{
  \frametitle{ До установки печати }
...
\frame{
  \frametitle{ После установки печати }
